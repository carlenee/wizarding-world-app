...
import 'package:wizarding_world/utils/feth_slytherin_character.dart';
...
class SlytherinCharacterPage extends StatefulWidget {
  const SlytherinCharacterPage({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _SlytherinCharacterPageState();
}

class _SlytherinCharacterPageState extends State<SlytherinCharacterPage> {
  @override
